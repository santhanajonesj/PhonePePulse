...
icon = Image.open("PhonePe\ICN.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Santhana Jones",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Jones*!
                                        for phonepe pulse data"""})
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('PhonePe\state_names.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/santhanajonesj/PhonePePulse")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("PhonePe\PhonePePulse.jpg")